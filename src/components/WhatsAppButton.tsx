...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 text-white rounded-full flex items-center justify-center shadow-xl transition-all duration-300 whatsapp-pulse hover:bg-green-600 hover:scale-110 active:scale-95 ${
